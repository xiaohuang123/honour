	...
	margin-top: -75px;
							...
							<div class="Add_Paper_append ng-scope">
								<div class="apa_le my_ques-apa_le">
									...
									<%-- <div class="apa_le-tj">
										<a href="${pageContext.request.contextPath}/add.do?type=1">添加单选题</a>
									</div> --%>
									<div class="apa_le-tj">
										<a href="${pageContext.request.contextPath}/add.do?sid=${tqv.sid}&type=2">添加填空题</a>
									</div>
									<%-- <div class="apa_le-tj">	
										<a href="${pageContext.request.contextPath}/add.do?type=3">添加多选题</a>
									</div> --%>
								</div>
												...
												<div ng-if="q.questype==4 || q.questype==5"
													...
													<div class="apa_ri-cenbt">
														...
														<span class="questype ng-scope" ng-if="q.questype==5"
															style="color: #2abcb8; font-weight: bolder;">填空题</span>
													...
													<ul class="apa_ri-cenul">
														<div class="answerBox">
															<span style="color: #ff8a00;">答案：</span>
															<pre style="color: #29bdb9; word-break: break-all; width: 100%"	ng-bind-html="q.answer | trustHtml" class="ng-binding">
																<p align="left">
																 	<font style="font-family:楷体;font-size: 19px; color:fuchsia;">
																 	${teq._option}</font>
																</p>
																<p align="left">
																	<font style="font-family: 楷体;font-size: 22px; color: blue;">题目解析：</font>
																	${teq.answer}
																</p>
															</pre>
														</div>
