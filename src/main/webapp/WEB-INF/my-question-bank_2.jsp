...
<div class="plist test_public  prof_t ng-scope">
    ...
    <div class="sp_Tcen">
        ...
        <div class="sp_Tcb1 addpap_t9 questype">
            <span>题型：</span>
            <ul>
                <li class="A_N_P_Ali" id="1"><a href="${pageContext.request.contextPath}/add.do?type=1">单选题</a><em></em></li>
                <li class="A_N_P_Ali" id="2"><a href="${pageContext.request.contextPath}/add.do?type=3">多选题</a><em></em></li>
                <li class="" id="3">判断题<em></em></li>
                <li class="A_N_P_Ali" id="4"><a href="${pageContext.request.contextPath}/add.do?type=2">填空题</a><em></em></li>
