...
<div class="plist test_public  prof_t ng-scope">
    ...
    <div class="sp_Tcen">
        ...
        <div class="sp_Tcb1 addpap_t9 questype">
            <span>题型：</span>
            <ul>
                <li class="" id="1">单选题<em></em></li>
                <li class="" id="2">多选题<em></em></li>
                <li class="" id="7">不定项选择题<em></em></li>
                <li class="A_N_P_Ali" id="4"><a href="${pageContext.request.contextPath}/showQuestion.do?type=2&sid=${teq.sid}">填空题</a><em></em></li>
        ...
        <div class="danxuan danxuan-s" style="display: block">
            ...
            <div class="answer">
              ...
              <div class="optionsListBox ng-scope" ng-if="searchItem.options==undefined">
                    <div class="answer1 an editorBox utitl">
                   		<textarea rows="5" cols="8" name="options" style="background-color: aqua;"> ${teq._option}</textarea>
                    <div class="clear"></div>
                </div>
                </div>
            </div>
