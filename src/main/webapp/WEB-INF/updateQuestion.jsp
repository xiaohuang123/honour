...
<div class="plist test_public  prof_t ng-scope">
    ...
    <div class="sp_Tcen">
        ...
        <div class="sp_Tcb1 addpap_t9 questype">
            <span>题型：</span>
            <ul>
                <li class="A_N_P_Ali" id="1"><a href="${pageContext.request.contextPath}/showQuestion.do?type=1&sid=${teq.sid}">单选题</a><em></em></li>
                            ...
                            <td>
                                <div class="content">
                                    <div  class="addQues-optextarea-div" contenteditable="true">
                                    	<input type="text" name="options"  value="${teq.ops[0]}" style="width:100%;height:30px;background-color:aqua;">
                                    </div>
                                </div>
                            </td>
                    ...
                    <table>
                        <tbody><tr>
                            ...
                            <td>
                                <div class="content">
                                    <div class="addQues-optextarea-div" contenteditable="true">
                                    	<input type="text" name="options"  value="${teq.ops[1]}" style="width:100%;height:30px;background-color:aqua;">
                                    </div>
                                </div>
                            </td>
                    ...
                    <table>
                        <tbody><tr>
                            ...
                            <td>
                                <div class="content">
                                    <div class="addQues-optextarea-div" contenteditable="true">
                                    	<input type="text" name="options" value="${teq.ops[2]}" style="width:100%;height:30px;background-color:aqua;">
                                    </div>
                                </div>
                            </td>
