    ...
    if(window.acm.hrHeader!=undefined && location.host!="kaosys1.acmcoder.com:14822"){
        ...
        window.acm.userLink.forEach(function(List){
            if(List.title.indexOf("退出")>-1){
                ...
                $("#uemail").append('<li class="yonghuGuanli" style="text-align: center;width: 110px;height: 32px;"><a  style="width: 108px;padding: 8px 0px;font-size: 12px;" href="' + List.url + '"><img src="'+List.imgurl+'" style="width: 14px;position: relative;left: -10px;top: -2px;">&nbsp;'+ List.title + '</a></li>');
